...
var is_highlighter_enabled = false
...
func load_config(config_name: String) -> void:
	"""Loads a valid file stored in res://param_configs/ that has a .cfg extension.
	...
	if dir.open("res://param_configs") == ERR_INVALID_PARAMETER:
		dir.make_dir("res://param_configs")
		save_config("Default")
...
func save_config(config_name: String) -> void:
	...
	config.save("res://param_configs/%s.cfg" % config_name)
